...
/// Executes `SHA_EXTEND`.
pub const SHA_EXTEND: u32 = 0x30_01_00_05;
...
pub const ED_DECOMPRESS: u32 = 0x00_01_00_08;

/// Executes `KECCAK_SPONGE`.
pub const KECCAK_SPONGE: u32 = 0x01_01_00_09;

/// Executes `SECP256K1_ADD`.
pub const SECP256K1_ADD: u32 = 0x01_01_00_0A;

/// Executes `SECP256K1_DOUBLE`.
pub const SECP256K1_DOUBLE: u32 = 0x00_01_00_0B;

/// Executes `K256_DECOMPRESS`.
pub const SECP256K1_DECOMPRESS: u32 = 0x00_01_00_0C;

/// Executes `SECP256R1_ADD`.
pub const SECP256R1_ADD: u32 = 0x01_01_00_2C;

/// Executes `SECP256R1_DOUBLE`.
pub const SECP256R1_DOUBLE: u32 = 0x00_01_00_2D;

/// Executes `SECP256R1_DECOMPRESS`.
pub const SECP256R1_DECOMPRESS: u32 = 0x00_01_00_2E;

/// Executes `U256XU2048_MUL`.
pub const U256XU2048_MUL: u32 = 0x01_01_00_2F;

/// Executes `BN254_ADD`.
pub const BN254_ADD: u32 = 0x01_01_00_0E;

/// Executes `BN254_DOUBLE`.
pub const BN254_DOUBLE: u32 = 0x00_01_00_0F;
...
pub const BLS12381_DECOMPRESS: u32 = 0x00_01_00_1C;

/// Executes the `UINT256_MUL` precompile.
pub const UINT256_MUL: u32 = 0x01_01_00_1D;

/// Executes the `BLS12381_ADD` precompile.
pub const BLS12381_ADD: u32 = 0x01_01_00_1E;

/// Executes the `BLS12381_DOUBLE` precompile.
pub const BLS12381_DOUBLE: u32 = 0x00_01_00_1F;

/// Executes the `BLS12381_FP_ADD` precompile.
pub const BLS12381_FP_ADD: u32 = 0x01_01_00_20;

/// Executes the `BLS12381_FP_SUB` precompile.
pub const BLS12381_FP_SUB: u32 = 0x01_01_00_21;

/// Executes the `BLS12381_FP_MUL` precompile.
pub const BLS12381_FP_MUL: u32 = 0x01_01_00_22;

/// Executes the `BLS12381_FP2_ADD` precompile.
pub const BLS12381_FP2_ADD: u32 = 0x01_01_00_23;

/// Executes the `BLS12381_FP2_SUB` precompile.
pub const BLS12381_FP2_SUB: u32 = 0x01_01_00_24;

/// Executes the `BLS12381_FP2_MUL` precompile.
pub const BLS12381_FP2_MUL: u32 = 0x01_01_00_25;

/// Executes the `BN254_FP_ADD` precompile.
pub const BN254_FP_ADD: u32 = 0x01_01_00_26;

/// Executes the `BN254_FP_SUB` precompile.
pub const BN254_FP_SUB: u32 = 0x01_01_00_27;

/// Executes the `BN254_FP_MUL` precompile.
pub const BN254_FP_MUL: u32 = 0x01_01_00_28;

/// Executes the `BN254_FP2_ADD` precompile.
pub const BN254_FP2_ADD: u32 = 0x01_01_00_29;

/// Executes the `BN254_FP2_SUB` precompile.
pub const BN254_FP2_SUB: u32 = 0x01_01_00_2A;

/// Executes the `BN254_FP2_MUL` precompile.
pub const BN254_FP2_MUL: u32 = 0x01_01_00_2B;
